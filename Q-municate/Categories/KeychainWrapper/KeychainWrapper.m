...
- (void)resetKeychainItem
{
    ...
    else if (_keychainData)
    {
        ...
        OSStatus __unused errorcode = SecItemDelete((__bridge CFDictionaryRef)tmpDictionary);
...
- (void)writeToKeychain {
                            ...
                            (CFTypeRef *)&attributes) == noErr)
    {
        ...
        OSStatus __unused errorcode = SecItemUpdate(
    ...
    else
    {
        ...
        OSStatus __unused errorcode = SecItemAdd(
